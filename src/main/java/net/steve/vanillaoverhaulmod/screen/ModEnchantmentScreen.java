...
public class ModEnchantmentScreen extends AbstractContainerScreen<ModEnchantmentMenu> {
    ...
    private static final ResourceLocation ENCHANTING_TABLE_LOCATION = new ResourceLocation(VanillaOverhaulMod.MOD_ID, "textures/gui/mod_enchanting_table.png");
    ...
    public ModEnchantmentScreen(ModEnchantmentMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderBg(GuiGraphics pGuiGraphics, float pPartialTick, int pMouseX, int pMouseY) {
        ...
        for(int l = 0; l < 3; ++l) {
            ...
            if (k1 == 0) {
                ...
                int i2 = 6839882;
                if (this.menu.enchantClue[l] == -1) { // Forge: render buttons as disabled when enchantable but enchantability not met on lower levels
                    pGuiGraphics.blit(ENCHANTING_TABLE_LOCATION, i1, j + 14 + 19 * l, 0, 185, 108, 19);
        ...
        for(int j = 0; j < 3; ++j) {
            ...
            if (this.isHovering(60, 14 + 19 * j, 108, 17, (double)pMouseX, (double)pMouseY) && k > 0) {
                ...
                if (enchantment == null) {
                    ...
                    MutableComponent mutablecomponent = Component.translatable("container.enchant.diamond.one");
                    list.add(mutablecomponent.withStyle(i >= 1 ? ChatFormatting.GRAY : ChatFormatting.RED));
                }
