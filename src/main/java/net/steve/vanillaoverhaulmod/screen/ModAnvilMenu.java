...
public class ModAnvilMenu extends ItemCombinerMenu {
    ...
    public ModAnvilMenu(int pContainerId, Inventory pPlayerInventory) {
        this(pContainerId, pPlayerInventory, ContainerLevelAccess.NULL);
    }

    public ModAnvilMenu(int pContainerId, Inventory pPlayerInventory, FriendlyByteBuf friendlyByteBuf) {
        this(pContainerId, pPlayerInventory, ContainerLevelAccess.NULL);
    }

    public ModAnvilMenu(int pContainerId, Inventory pPlayerInventory, ContainerLevelAccess pAccess) {
        super(ModMenuTypes.MOD_ANVIL_MENU.get(), pContainerId, pPlayerInventory, pAccess);
    ...
    protected void onTake(Player pPlayer, ItemStack pStack) {
        float breakChance = net.minecraftforge.common.ForgeHooks.onAnvilRepair(pPlayer, pStack, ModAnvilMenu.this.inputSlots.getItem(0), ModAnvilMenu.this.inputSlots.getItem(1));
    ...
    public static boolean onAnvilChange(ModAnvilMenu container, @NotNull ItemStack left, @NotNull ItemStack right, Container outputSlot, String name, int baseCost, Player player)
    {
